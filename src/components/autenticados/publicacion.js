        ...
        return (
            ...
            <View>
                <View style={styles.header}>
                    ...
                    <Text>{autor.nombre}</Text></View>
                <Image source={{uri: item.secure_url}} style={{width: width, height : height}} />
                <View style={styles.footer}>
                    <View style={styles.icons}>
                    <Ionicons name = 'md-heart-outline' color='#000' size={30} style={styles.icon}/>
                    <Ionicons name = 'md-chatboxes' color='#000' size={30} style={styles.icon}/>
                    </View>
